				...
				<c:choose>
					<c:when test="${successo == null}">
						<form novalidate onsubmit="return utilities.validate(this)"
							...
							<div class="form-group">
								<label for="field-password">Password</label> <input
							...
							<div class="form-group">
								<label for="field-repeat">Ripeti Password</label> <input
					...
					<c:otherwise>
						<div class="alert alert-success" role="alert">L'utente è
							stato registrato con successo.</div>
					</c:otherwise>
				</c:choose>
			</div>
