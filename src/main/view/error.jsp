...
<script
    src="${pageContext.servletContext.contextPath}/assets/js/jquery-3.3.1.min.js"></script>
<script
        ...
        <div class="content" style="flex-direction: column; padding: 16px">
            ...
            <c:choose>
                ...
                <c:when test="${pageContext.errorData.statusCode >= 500}">
                    <h5>Si è verificato un problema col server. La
                        invitiamo a riprovare più tardi</h5>
                </c:when>
                <c:when test="${pageContext.errorData.statusCode >= 400}">
                    <h5>Pagina non raggiungibile</h5>
                </c:when>
                <c:otherwise>
